# STI - Sistema de Talleres Integrado 
...
- **Seguridad y Accesos**: Autenticación mediante control de roles.
- **Gestión de Clientes**: Base de datos de clientes con historial de altas, datos de contacto y facturación.
- **Gestión de Vehículos**: Registro de los vehículosque han pasado por el taller vinculado a sus respectivos dueños.
...
Para desplegar este proyecto con contenedores Docker:
